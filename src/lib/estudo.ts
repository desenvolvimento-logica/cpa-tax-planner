...
export const estudoExemplo: Estudo = {
  ...
  simulacoes: {
    simplesAtual: [35411.9, 30596.68, 27734.26, 31188.86, 30416.7, 31739.41, 0, 0, 0, 0, 0, 0],
    simplesHibrido: [46558.28, 40609.96, 35601.8, 40560.19, 39368.59, 41448.13, 0, 0, 0, 0, 0, 0],
    lucroPresumido: [45971.73, 41651.19, 93613.98, 41150.94, 40070.54, 99291.66, 0, 0, 0, 0, 0, 0],
    lucroReal: [45971.73, 41651.19, 82596.58, 41150.94, 40070.54, 123950.18, 0, 0, 0, 0, 0, 0],
    tributos: {
      simplesAtual: [
