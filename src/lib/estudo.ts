...
export const diagnosticoPadrao: Diagnostico = {
  ...
  proximosPassos:
    "Avaliar, com base neste diagnóstico, o peso dos clientes do regime regular no seu faturamento e o risco de perder competitividade junto a eles.\nRevisar a política de preços e de contratos, considerando que o crédito repassado passa a ser parte da negociação comercial.\nOrganizar o cadastro de fornecedores: identificar quem não gera crédito e negociar condições ou buscar alternativas.\nContratar a Análise Tributária Completa, com as simulações necessárias para dimensionar o impacto de caixa da migração.\nRespeitar os prazos: opção de 1º a 30 de setembro de 2026 e cancelamento até o último dia de novembro de 2026.",
  pacote:
