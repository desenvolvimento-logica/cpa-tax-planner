...
export function SecaoFolha({
  ...
  return (
    <Painel numero="04" titulo="Folha de pagamento">
      <p className="mb-4 text-xs text-muted-foreground">Base total mensal informada na seção INSS do Resumo da Folha.</p>
      ...
      <div className="mt-5 flex flex-wrap gap-4">
        <div className="clip-bar bg-frost px-5 py-3 ring-1 ring-line">
          <p className="text-[11px] uppercase tracking-widest text-muted-foreground">Meses informados</p>
        ...
        <div className="clip-bar bg-frost px-5 py-3 ring-1 ring-line">
          <p className="text-[11px] uppercase tracking-widest text-muted-foreground">Folha acumulada</p>
